...
- ✅ `maxClaimPerTx` (cap par tx) + `maxClaimsPerDay` (compteur tumbling 24h via `claimWindows` mapping)
- ✅ `setClaimLimits(maxPerTx, maxPerDay)` admin-gated
- ✅ `getClaimStatus(user)` view pour la webapp
