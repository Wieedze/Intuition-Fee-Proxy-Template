...
export const CANONICAL_VERSIONS: Record<NetworkName, CanonicalRegistry> = {
  ...
  testnet: {
    versions: {
      'v2.0.0': {
        label: 'v2.0.0',
        impl: '0xc6a6c8fDB94451423615e6634b01E38f104c0af4',
        family: 'standard',
        review: { url: 'https://github.com/Wieedze/Intuition-Proxy-Factory', date: '2026-04-27' },
        summary: 'Standard impl — user pays assets + Sofia fee from their wallet. Bytecode refresh: createAtoms/createTriples now take per-item minShares[]; deposit() takes maxFeeBps + maxFixedFee front-run caps.',
      },
      'v2.0.0-sponsored': {
        label: 'v2.0.0-sponsored',
        impl: '0xA6c3af7C06a92F17f8550a328dB3a88042370cb8',
        family: 'sponsored',
        review: { url: 'https://github.com/Wieedze/Intuition-Proxy-Factory', date: '2026-04-27' },
        summary: 'Sponsored impl — pool pays assets + Sofia fee (fee on top). Permissionless fundPool, admin reclaims accumulated fees via withdraw. Bytecode refresh: createAtoms/createTriples now take per-item minShares[].',
      },
      'v2.1.0': {
        label: 'v2.1.0',
        impl: '0x9eabb1dD1A26e0f17956B30B8665A43da6986fda',
        family: 'standard',
        review: { url: 'https://github.com/Wieedze/Intuition-Proxy-Factory', date: '2026-04-27' },
        summary: 'Standard sibling adding a VersionUsed(version, user) marker on every write-path call — indexers can attribute each tx to the active impl. Inherits v2.0.0\'s minShares[] + maxFeeBps caps.',
      },
      'v2.1.0-sponsored': {
        label: 'v2.1.0-sponsored',
        impl: '0x7b67d891917627eB08feFeef870F62b1AB85D896',
        family: 'sponsored',
        review: { url: 'https://github.com/Wieedze/Intuition-Proxy-Factory', date: '2026-04-27' },
        summary: 'Sponsored sibling of v2.1.0 — same VersionUsed marker, version() returns "v2.1.0-sponsored". Inherits the fee-on-top model + permissionless fundPool + minShares[] slippage on create*.',
      },
    },
    latest: {
      standard: 'v2.1.0',
